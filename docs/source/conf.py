...
# restaurant_pipeline documentation build
...
from restaurant_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "restaurant_pipeline"
author = "Kedro"
...
htmlhelp_basename = "restaurant_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "restaurant_pipeline.tex",
        "restaurant_pipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "restaurant_pipeline",
        "Project restaurant_pipeline codebase.",
        "Data-Science",
    )
]
